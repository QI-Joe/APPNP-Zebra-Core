...
class Running_Permit:
    ...
    def set_all_true(self):
        """
        force __call__ return all true value
        """
        self.all_true=True
...
def get_graph(dataset: str, split_ratio: float):
    print("This function is not implemented, remember to correct")

def get_data_node(dataset_name: str, snapshot: int, test_mode: bool):
    print("This function is not implemented, remember to correct")
